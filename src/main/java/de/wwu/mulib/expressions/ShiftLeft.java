 ...
 */
public class ShiftLeft extends AbstractOperatorMathematicalExpression implements NumericBitwiseOperation {
    protected ShiftLeft(Expression expr0, Expression expr1) {
        super(expr0, expr1);
    }
