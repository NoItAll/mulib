...
public class SootMulibClassesAndMethods {
    ...
    public SootMulibClassesAndMethods() {
        ...
        SC_SUBSTITUTED_VAR = Scene.v().forceResolve(Substituted.class.getName(), SootClass.SIGNATURES);
        ...
        SM_SE_ALIASING_SYM_OBJECT_WITHIN_ARRAY = SC_SE.getMethod("aliasOf", List.of(TYPE_PARTNER_CLASS.getArrayType()), TYPE_PARTNER_CLASS);
        SM_SE_ALIASING_SYM_SINT_WITHIN_ARRAY   = SC_SE.getMethod("aliasOf", List.of(TYPE_SINT.getArrayType()), TYPE_SINT);
        SM_SE_ALIASING_SYM_SLONG_WITHIN_ARRAY  = SC_SE.getMethod("aliasOf", List.of(TYPE_SLONG.getArrayType()), TYPE_SLONG);
        SM_SE_ALIASING_SYM_SDOUBLE_WITHIN_ARRAY= SC_SE.getMethod("aliasOf", List.of(TYPE_SDOUBLE.getArrayType()), TYPE_SDOUBLE);
        SM_SE_ALIASING_SYM_SFLOAT_WITHIN_ARRAY = SC_SE.getMethod("aliasOf", List.of(TYPE_SFLOAT.getArrayType()), TYPE_SFLOAT);
        SM_SE_ALIASING_SYM_SBOOL_WITHIN_ARRAY  = SC_SE.getMethod("aliasOf", List.of(TYPE_SBOOL.getArrayType()), TYPE_SBOOL);
        SM_SE_ALIASING_SYM_SBYTE_WITHIN_ARRAY  = SC_SE.getMethod("aliasOf", List.of(TYPE_SBYTE.getArrayType()), TYPE_SBYTE);
        SM_SE_ALIASING_SYM_SSHORT_WITHIN_ARRAY = SC_SE.getMethod("aliasOf", List.of(TYPE_SSHORT.getArrayType()), TYPE_SSHORT);
        SM_SE_ALIASING_SYM_SCHAR_WITHIN_ARRAY  = SC_SE.getMethod("aliasOf", List.of(TYPE_SCHAR.getArrayType()), TYPE_SCHAR);
        SM_SE_ALIASING_SYM_OBJECT_WITHIN_SARRAY = SC_SE.getMethod("aliasOf", List.of(TYPE_PARTNER_CLASSSARRAY), TYPE_PARTNER_CLASS);
        SM_SE_ALIASING_SYM_SINT_WITHIN_SARRAY      = SC_SE.getMethod("aliasOf", List.of(TYPE_SINTSARRAY), TYPE_SINT);
        SM_SE_ALIASING_SYM_SLONG_WITHIN_SARRAY     = SC_SE.getMethod("aliasOf", List.of(TYPE_SLONGSARRAY), TYPE_SLONG);
        SM_SE_ALIASING_SYM_SDOUBLE_WITHIN_SARRAY   = SC_SE.getMethod("aliasOf", List.of(TYPE_SDOUBLESARRAY), TYPE_SDOUBLE);
        SM_SE_ALIASING_SYM_SFLOAT_WITHIN_SARRAY    = SC_SE.getMethod("aliasOf", List.of(TYPE_SFLOATSARRAY), TYPE_SFLOAT);
        SM_SE_ALIASING_SYM_SBOOL_WITHIN_SARRAY     = SC_SE.getMethod("aliasOf", List.of(TYPE_SBOOLSARRAY), TYPE_SBOOL);
        SM_SE_ALIASING_SYM_SBYTE_WITHIN_SARRAY     = SC_SE.getMethod("aliasOf", List.of(TYPE_SBYTESARRAY), TYPE_SBYTE);
        SM_SE_ALIASING_SYM_SSHORT_WITHIN_SARRAY    = SC_SE.getMethod("aliasOf", List.of(TYPE_SSHORTSARRAY), TYPE_SSHORT);
        SM_SE_ALIASING_SYM_SCHAR_WITHIN_SARRAY     = SC_SE.getMethod("aliasOf", List.of(TYPE_SCHARSARRAY), TYPE_SCHAR);
