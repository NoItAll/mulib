...
public final class Mulib {
    ...
    public static List<PathSolution> executeMulib(
            ...
            Object... args) {
        return executeMulib(methodName, methodOwnerClass, mb, null, args);
    }
     ...
     * of the search region this method solely throws an exception.
     ...
     * as otherwise an exception is thrown without any other effect.
     ...
     * This method must be transformed by a program transformation as otherwise an exception is thrown without any other effect.
