...
// HW: Adapted to fit Mulib, taken from https://github.com/sosy-lab/sv-benchmarks/blob/99d37c5b4072891803b9e5c154127c912477f705/java/java-ranger-regression/WBS/prop4/Main.java
public class WBSProp4 {
    ...
    public static void exec() { // HW: Changed from main to exec
        ...
        for (int i = 0; i < 2; i++) { // HW: Changed from four to two iterations to be more feasible as a normal test case
            PedalPos = Mulib.namedFreeInt("PedalPos");
