...
// The class has been renamed and altered to fit Mulib.
public class WBSTransf {
    ...
    public static WBSTransf launch() {
        int pedal1 = Mulib.trackedFreeInt("pedal1");
        boolean auto1 = Mulib.trackedFreeBoolean("auto1");
        boolean skid1 = Mulib.trackedFreeBoolean("skid1");
        int pedal2 = Mulib.trackedFreeInt("pedal2");
        boolean auto2 = Mulib.trackedFreeBoolean("auto2");
        boolean skid2 = Mulib.trackedFreeBoolean("skid2");
        int pedal3 = Mulib.trackedFreeInt("pedal3");
        boolean auto3 = Mulib.trackedFreeBoolean("auto3");
        boolean skid3 = Mulib.trackedFreeBoolean("skid3");
